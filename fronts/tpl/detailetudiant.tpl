...
<head>
    ...
    <link rel="stylesheet" href="detailentre.css" />
    <link rel="stylesheet" href="detailetudiant.css" />
...
<body>
    <div class="dtails-dune-entreprise">
        <div class="container">
            ...
            <img class="cadres2" src="contact1.png" />
            <select class="select" name="Option">
                <option value="supp">Supprimer</option>
                <option value="mod">Modifier</option>
            </select>
            <div class="secteur2">Secteur : IT</div>
            <div class="adresse2">Adresse : 13 Avenue Simone Veil</div>
            <div class="ville-nice2">Ville : Nice</div>
            <div class="e-mail2">
                e-mail : amel.gustin@gmail.com
            </div>
            <div class="niveau-scolaire3">Niveau scolaire : Bac +2</div>
            <div class="code-postal2">Code postal : 06200</div>
            <div class="comptences2">Compétences :</div>
            <div class="contact-btcontainer">
                <button class="contact-btn2">Contacter</button>
            </div>
            <div class="fille">Amel Gustin</div>
            <div class="descompet">
                Html, CSS, Javascript, PHP, MySQL, Smarty, MongoDB
            </div>
